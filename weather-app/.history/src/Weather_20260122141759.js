...
import sunnyGirl from "../assets/animations/sunnyGirl.json";
import rainGirl from "../assets/animations/rainGirl.json";
import cloudyGirl from "../assets/animations/cloudyGirl.json";
import snowGirl from "../assets/animations/snowGirl.json";
import defaultGirl from "../assets/animations/defaultGirl.json";
...
function Weather({ weather, darkMode }) {
  ...
  return (
    <div className={`weather-card glass ${darkMode ? "dark" : ""}`}>
